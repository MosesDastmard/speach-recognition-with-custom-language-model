...
from moswer import transforms as tr
from moswer.transformations import wer_default, wer_standardize, cer_default_transform
...
def compute_measures(
    ...
    **kwargs
    ...
    for groundtruth_sentence, hypothesis_sentence in zip(truth, hypothesis):
        ...
        hits, substitutions, deletions, insertions, editop = _get_operation_counts(
